...
import tradingSim.dto.*;
import tradingSim.model.*;
import tradingSim.service.*;
...
public class TradingSimApplication {
	...
	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(TradingSimApplication.class, args);
