...
public class Order implements Tradable{
    ...
    private int originalVolume, remainingVolume, cancelledVolume, filledVolume;
    ...
    public String toString() {
        return String.format("%s %s order: %s at %s, Orig Vol: %d, Rem Vol: " +
                "%d, Fill Vol: %d, CXL Vol: %d, ID: %s", user,
                side.toString(), product, price, originalVolume,
